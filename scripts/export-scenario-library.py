...
with db:
 ...
 for s in read('data/studio/task-guides.json')+read('data/studio/extended-tasks.json')+read('data/studio/additional-tasks.json')+read('data/studio/practical-tasks.json')+read('data/studio/domain-tasks.json')+read('data/studio/deep-tasks.json'):db.execute('INSERT OR REPLACE INTO task_resources VALUES(?,?,?)',(s['id'],'published',json.dumps(s,ensure_ascii=False)))
