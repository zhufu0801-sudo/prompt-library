...
scenarios=read('data/studio/scenarios.json')+read('data/studio/prompts-chat-curated.json')+read('data/studio/spatial-scenarios.json')+read('data/studio/engineering-scenarios.json')
