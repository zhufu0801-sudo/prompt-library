...
最新补充：可选账号保存与跨设备访问、管理员意见审核、每周整理已接纳意见、28 个 Skill 包检查报告、16 个关怀版选择，以及多任务拆分建议。详见 [本轮落实与验证](docs/completion-release.md)。
...
Current release (2026-09-16): **57 homepage modules, 239 library task templates + 10 editing tasks, 45 detailed scenarios, 28 downloadable Skill instruction packs (24 upstream/adapted + 4 original)**. All homepage prompts and usage instructions support Chinese, English and Japanese. See [release and content maintenance](docs/DOMAIN-LIBRARY.md).
...
完整库共366条（87条原创、279条导入）；首页可直接选择239个细分任务模板，另有10个图片/视频修改任务。五个其他方向的关键词规则和20个学习草稿保留在数据库中，暂不上首页。
...
- 首页57个三语模块、239个可直接选择的细分任务；另保留早期10类30条原创模板。
...
- 独立关怀版：说说需求 → 核对意思 → 复制给 AI；免费本地规则整理，大字、大按钮，支持三语。
